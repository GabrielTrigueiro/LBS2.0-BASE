...
import { BoxLink, LinkContainer, LinkText, TitleLink } from './styles';
...
const Links = () => {
    ...
    return (
        <PageContentContainer>
            <LinkContainer>
                <BoxLink>
                    <Box sx={{ display: "flex", flexDirection: "row", flex: 1, alignItems: "center", justifyContent: "space-around" }}>
                        ...
                        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                            ...
                            <LinkBox>
                                ...
                                <IconButton onClick={() => handleCopyClick("limpaNome", data?.data.CAMPANHA26022024)} sx={{ marginLeft: "7px" }}>
                    ...
                    <Box sx={{ display: "flex", flexDirection: "row", flex: 1, alignItems: "center", justifyContent: "space-around" }}>
                        ...
                        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                            ...
                            <LinkBox>
                                ...
                                <IconButton onClick={() => handleCopyClick("consultoria", data?.data.CAMPANHA26022024)} sx={{ marginLeft: "7px" }}>
                                    <ContentCopyIcon color="primary" />
                                </IconButton>
                            </LinkBox>
                        </Box>
